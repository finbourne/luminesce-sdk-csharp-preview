...
namespace Finbourne.Luminesce.Sdk.Api
{
    ...
    public interface IBinaryDownloadingApiSync : IApiAccessor
    {
        ...
        ICollection<string> GetBinaryVersions(LuminesceBinaryType? type = default(LuminesceBinaryType?));
        ...
        ApiResponse<ICollection<string>> GetBinaryVersionsWithHttpInfo(LuminesceBinaryType? type = default(LuminesceBinaryType?));
    ...
    public interface IBinaryDownloadingApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ICollection<string>> GetBinaryVersionsAsync(LuminesceBinaryType? type = default(LuminesceBinaryType?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ICollection<string>>> GetBinaryVersionsWithHttpInfoAsync(LuminesceBinaryType? type = default(LuminesceBinaryType?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class BinaryDownloadingApi : IBinaryDownloadingApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] GetBinaryVersions: Gets the list of available versions of a user-downloadable binary from Nexus  Gets all available versions of a given binary type (from newest to oldest) This does not mean you are entitled to download them.
        /// </summary>
        /// <exception cref="Finbourne.Luminesce.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="type">Type of binary to fetch available versions of (optional)</param>
        /// <returns>ICollection&lt;string&gt;</returns>
        public ICollection<string> GetBinaryVersions(LuminesceBinaryType? type = default(LuminesceBinaryType?))
        {
            Finbourne.Luminesce.Sdk.Client.ApiResponse<ICollection<string>> localVarResponse = GetBinaryVersionsWithHttpInfo(type);
            return localVarResponse.Data;
        }
        ...
        /// <param name="type">Type of binary to fetch available versions of (optional)</param>
        /// <returns>ApiResponse of ICollection&lt;string&gt;</returns>
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<ICollection<string>> GetBinaryVersionsWithHttpInfo(LuminesceBinaryType? type = default(LuminesceBinaryType?))
        {
            Finbourne.Luminesce.Sdk.Client.RequestOptions localVarRequestOptions = new Finbourne.Luminesce.Sdk.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<ICollection<string>>("/api/Download/versions", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetBinaryVersions", localVarResponse);
                if (_exception != null) throw _exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ICollection&lt;string&gt;</returns>
        public async System.Threading.Tasks.Task<ICollection<string>> GetBinaryVersionsAsync(LuminesceBinaryType? type = default(LuminesceBinaryType?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Luminesce.Sdk.Client.ApiResponse<ICollection<string>> localVarResponse = await GetBinaryVersionsWithHttpInfoAsync(type, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ICollection&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Luminesce.Sdk.Client.ApiResponse<ICollection<string>>> GetBinaryVersionsWithHttpInfoAsync(LuminesceBinaryType? type = default(LuminesceBinaryType?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<ICollection<string>>("/api/Download/versions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
