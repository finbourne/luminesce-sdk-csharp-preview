...
namespace Finbourne.Luminesce.Sdk.Api
{
    ...
    public partial class SqlExecutionApi : ISqlExecutionApi
    {
        ...
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<string> PutSqlToViewDesignWithHttpInfo(string body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling SqlExecutionApi->PutSqlToViewDesign");
        ...
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<string> PutSqlToWriterDesignWithHttpInfo(string body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling SqlExecutionApi->PutSqlToWriterDesign");
        ...
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<string> PutWriterDesignToSqlWithHttpInfo(WriterDesign writerDesign)
        {
            ...
            if (writerDesign == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'writerDesign' when calling SqlExecutionApi->PutWriterDesignToSql");
