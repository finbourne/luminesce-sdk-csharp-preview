...
namespace Finbourne.Luminesce.Sdk.Api
{
    ...
    public interface ISqlBackgroundExecutionApiSync : IApiAccessor
    {
        ...
        ApiResponse<BackgroundQueryProgressResponse> GetProgressOfWithHttpInfo(string executionId, bool buildFromLogs);
        /// <summary>
    ...
    public interface ISqlBackgroundExecutionApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<BackgroundQueryProgressResponse> GetProgressOfAsync(string executionId, bool buildFromLogs, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<BackgroundQueryProgressResponse>> GetProgressOfWithHttpInfoAsync(string executionId, bool buildFromLogs, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// StartQuery: Starts to Execute LuminesceSql in the background.
        /// </summary>
        /// <remarks>
    ...
    public partial class SqlBackgroundExecutionApi : ISqlBackgroundExecutionApi
    {
        ...
        /// <param name="buildFromLogs">Should the response state be build from query logs if missing from the shared-db-state?  False will mean &#x60;404 Not Found&#x60; in cases where it was a real query but has passed its &#x60;keepForSeconds&#x60;  since the query completed (as well as &#39;this was not a query at all&#39; of course)</param>
        /// <returns>BackgroundQueryProgressResponse</returns>
        public BackgroundQueryProgressResponse GetProgressOf(string executionId, bool buildFromLogs)
        {
        ...
        /// <param name="buildFromLogs">Should the response state be build from query logs if missing from the shared-db-state?  False will mean &#x60;404 Not Found&#x60; in cases where it was a real query but has passed its &#x60;keepForSeconds&#x60;  since the query completed (as well as &#39;this was not a query at all&#39; of course)</param>
        /// <returns>ApiResponse of BackgroundQueryProgressResponse</returns>
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<BackgroundQueryProgressResponse> GetProgressOfWithHttpInfo(string executionId, bool buildFromLogs)
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BackgroundQueryProgressResponse</returns>
        public async System.Threading.Tasks.Task<BackgroundQueryProgressResponse> GetProgressOfAsync(string executionId, bool buildFromLogs, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BackgroundQueryProgressResponse)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Luminesce.Sdk.Client.ApiResponse<BackgroundQueryProgressResponse>> GetProgressOfWithHttpInfoAsync(string executionId, bool buildFromLogs, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'executionId' is set
            if (executionId == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'executionId' when calling SqlBackgroundExecutionApi->GetProgressOf");
