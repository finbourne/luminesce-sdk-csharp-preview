...
namespace Finbourne.Luminesce.Sdk.Api
{
    ...
    public interface ISqlDesignApiSync : IApiAccessor
    {
        ...
        /// <param name="provider">Name of the provider for which this template is for</param>
        /// <param name="contentType">File content type for the Template. csv or excel</param>
        ...
        ApiResponse<System.IO.Stream> GetProviderTemplateForExportWithHttpInfo(string provider, string contentType);
        /// <summary>
        ...
        CaseStatementDesign PutCaseStatementDesignSqlToDesign(string body = default(string));
        ...
        ApiResponse<CaseStatementDesign> PutCaseStatementDesignSqlToDesignWithHttpInfo(string body = default(string));
        /// <summary>
        ...
        ApiResponse<string> PutCaseStatementDesignToSqlWithHttpInfo(CaseStatementDesign caseStatementDesign);
        /// <summary>
    ...
    public interface ISqlDesignApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<System.IO.Stream> GetProviderTemplateForExportAsync(string provider, string contentType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<System.IO.Stream>> GetProviderTemplateForExportWithHttpInfoAsync(string provider, string contentType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] PutCaseStatementDesignSqlToDesign: Convert SQL to a case statement design object
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CaseStatementDesign> PutCaseStatementDesignSqlToDesignAsync(string body = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CaseStatementDesign>> PutCaseStatementDesignSqlToDesignWithHttpInfoAsync(string body = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] PutCaseStatementDesignToSql: Convert a case statement design object to SQL
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<string> PutCaseStatementDesignToSqlAsync(CaseStatementDesign caseStatementDesign, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> PutCaseStatementDesignToSqlWithHttpInfoAsync(CaseStatementDesign caseStatementDesign, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] PutFileReadDesignToSql: Make file read SQL from a design object
        /// </summary>
        /// <remarks>
    ...
    public partial class SqlDesignApi : ISqlDesignApi
    {
        ...
        /// <summary>
        /// GetProviderTemplateForExport: Makes a fields template for file importing via a writer Generates a template file for all the writable fields for a given provider returned in CSV or Excel (xlsx) format (as a file to be downloaded)
        /// </summary>
        /// <exception cref="Finbourne.Luminesce.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="provider">Name of the provider for which this template is for</param>
        /// <param name="contentType">File content type for the Template. csv or excel</param>
        /// <returns>System.IO.Stream</returns>
        public System.IO.Stream GetProviderTemplateForExport(string provider, string contentType)
        {
            Finbourne.Luminesce.Sdk.Client.ApiResponse<System.IO.Stream> localVarResponse = GetProviderTemplateForExportWithHttpInfo(provider, contentType);
        ...
        /// <param name="contentType">File content type for the Template. csv or excel</param>
        /// <returns>ApiResponse of System.IO.Stream</returns>
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<System.IO.Stream> GetProviderTemplateForExportWithHttpInfo(string provider, string contentType)
        {
            // verify the required parameter 'provider' is set
            if (provider == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'provider' when calling SqlDesignApi->GetProviderTemplateForExport");

            // verify the required parameter 'contentType' is set
            if (contentType == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'contentType' when calling SqlDesignApi->GetProviderTemplateForExport");
            ...
            localVarRequestOptions.QueryParameters.Add(Finbourne.Luminesce.Sdk.Client.ClientUtils.ParameterToMultiMap("", "provider", provider));
            localVarRequestOptions.QueryParameters.Add(Finbourne.Luminesce.Sdk.Client.ClientUtils.ParameterToMultiMap("", "contentType", contentType));
            ...
            localVarRequestOptions.HeaderParameters.Add("X-LUSID-Sdk-Version", "1.16.663");

            // make the HTTP request
            var localVarResponse = this.Client.Get<System.IO.Stream>("/api/Sql/providertemplateforexport", localVarRequestOptions, this.Configuration);

            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetProviderTemplateForExport", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of System.IO.Stream</returns>
        public async System.Threading.Tasks.Task<System.IO.Stream> GetProviderTemplateForExportAsync(string provider, string contentType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Luminesce.Sdk.Client.ApiResponse<System.IO.Stream> localVarResponse = await GetProviderTemplateForExportWithHttpInfoAsync(provider, contentType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (System.IO.Stream)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Luminesce.Sdk.Client.ApiResponse<System.IO.Stream>> GetProviderTemplateForExportWithHttpInfoAsync(string provider, string contentType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'provider' is set
            if (provider == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'provider' when calling SqlDesignApi->GetProviderTemplateForExport");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<System.IO.Stream>("/api/Sql/providertemplateforexport", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="body">SQL to attempt to create an case statement Design object from (optional)</param>
        /// <returns>CaseStatementDesign</returns>
        public CaseStatementDesign PutCaseStatementDesignSqlToDesign(string body = default(string))
        {
        ...
        /// <param name="body">SQL to attempt to create an case statement Design object from (optional)</param>
        /// <returns>ApiResponse of CaseStatementDesign</returns>
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<CaseStatementDesign> PutCaseStatementDesignSqlToDesignWithHttpInfo(string body = default(string))
        {
            Finbourne.Luminesce.Sdk.Client.RequestOptions localVarRequestOptions = new Finbourne.Luminesce.Sdk.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CaseStatementDesign</returns>
        public async System.Threading.Tasks.Task<CaseStatementDesign> PutCaseStatementDesignSqlToDesignAsync(string body = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Luminesce.Sdk.Client.ApiResponse<CaseStatementDesign> localVarResponse = await PutCaseStatementDesignSqlToDesignWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CaseStatementDesign)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Luminesce.Sdk.Client.ApiResponse<CaseStatementDesign>> PutCaseStatementDesignSqlToDesignWithHttpInfoAsync(string body = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="caseStatementDesign">CaseStatementDesign object to try and create a SQL query from</param>
        /// <returns>string</returns>
        public string PutCaseStatementDesignToSql(CaseStatementDesign caseStatementDesign)
        {
        ...
        /// <param name="caseStatementDesign">CaseStatementDesign object to try and create a SQL query from</param>
        /// <returns>ApiResponse of string</returns>
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<string> PutCaseStatementDesignToSqlWithHttpInfo(CaseStatementDesign caseStatementDesign)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> PutCaseStatementDesignToSqlAsync(CaseStatementDesign caseStatementDesign, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Luminesce.Sdk.Client.ApiResponse<string> localVarResponse = await PutCaseStatementDesignToSqlWithHttpInfoAsync(caseStatementDesign, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Luminesce.Sdk.Client.ApiResponse<string>> PutCaseStatementDesignToSqlWithHttpInfoAsync(CaseStatementDesign caseStatementDesign, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'caseStatementDesign' is set
            if (caseStatementDesign == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'caseStatementDesign' when calling SqlDesignApi->PutCaseStatementDesignToSql");
