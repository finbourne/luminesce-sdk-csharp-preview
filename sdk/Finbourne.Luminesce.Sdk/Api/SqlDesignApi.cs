...
namespace Finbourne.Luminesce.Sdk.Api
{
    ...
    public interface ISqlDesignApiSync : IApiAccessor
    {
        ...
        /// <param name="body">SQL query to generate the writer design object from</param>
        /// <returns>ApiResponse of string</returns>
        ApiResponse<string> PutSqlToWriterDesignWithHttpInfo(string body);
        /// <summary>
    ...
    public interface ISqlDesignApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of string</returns>
        System.Threading.Tasks.Task<string> PutSqlToWriterDesignAsync(string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        System.Threading.Tasks.Task<ApiResponse<string>> PutSqlToWriterDesignWithHttpInfoAsync(string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EXPERIMENTAL] PutViewDesignToSql: Generates view creation sql from a structured view creation design
        /// </summary>
        /// <remarks>
    ...
    public partial class SqlDesignApi : ISqlDesignApi
    {
        ...
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<string> PutFileReadDesignToSqlWithHttpInfo(FileReaderBuilderDef fileReaderBuilderDef, bool? executeQuery = default(bool?))
        {
            ...
            localVarRequestOptions.HeaderParameters.Add("X-LUSID-Sdk-Version", "1.14.486");
        ...
        /// <param name="body">SQL query to generate the writer design object from</param>
        /// <returns>string</returns>
        public string PutSqlToWriterDesign(string body)
        {
        ...
        /// <param name="body">SQL query to generate the writer design object from</param>
        /// <returns>ApiResponse of string</returns>
        public Finbourne.Luminesce.Sdk.Client.ApiResponse<string> PutSqlToWriterDesignWithHttpInfo(string body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> PutSqlToWriterDesignAsync(string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Luminesce.Sdk.Client.ApiResponse<string> localVarResponse = await PutSqlToWriterDesignWithHttpInfoAsync(body, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Luminesce.Sdk.Client.ApiResponse<string>> PutSqlToWriterDesignWithHttpInfoAsync(string body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new Finbourne.Luminesce.Sdk.Client.ApiException(400, "Missing required parameter 'body' when calling SqlDesignApi->PutSqlToWriterDesign");
