...
> string FetchQueryResultHistogram (string executionId, string bucketSize = null, string filter = null, bool? jsonProper = null)
...
namespace Example
{
    public class FetchQueryResultHistogramExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling HistoricallyExecutedQueriesApi.FetchQueryResultHistogram: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
